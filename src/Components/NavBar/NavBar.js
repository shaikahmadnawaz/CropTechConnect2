  ...
  return (
    <nav className="change-nav-scroll">
      ...
      <div className="nav">
        ...
        <ul>
          <li>
            <Link to="/CropSuggestion" className="nav-element CropSuggestion">
              Crops
            </Link>
          </li>
          <li>
            <Link to="/discussions" className="nav-element discussions">
              Discussions
            </Link>
          </li>

          <li>
            <Link to="/Aboutus" className="nav-element Aboutuss">
              About Us
            </Link>
          </li>
          ...
          {username === null && (
            <li>
              <Link to="/login" id="loginUser" className="nav-element">
                Guest
              </Link>
            </li>
          )}
          {username && (
            <li>
              <Link to="/login" id="loginUser" className="nav-element">
                {username.slice(0, 6).toUpperCase()}
              </Link>
            </li>
          )}
        </ul>
