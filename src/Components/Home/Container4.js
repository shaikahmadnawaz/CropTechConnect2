        ...
        <div id="row-fluid-wrapper-1 " className="row-fluid-wrapper mqcss1">
          ...
          <div className="row-fluid-wrapper-content-1" data-aos="zoom-in-left">
            ...
            <p>
              ...
              crops. The <strong>CROPS</strong> page takes input from the user
              and displays the best possible and suitable crops according to the
              input given. This page displays full-fledged details such as
              investment, water requirement, Gross income and total profit that
              can be earned.
              <br />
          ...
          <div className="row-fluid-h ">
            <blockquote className="quoteh cardh ">
              <div className="quote_content ">
                ...
                protect and preserve our environment then almost anyone else.
                They are some of the best environmentalists around."
                <br />
