      ...
      <div className="App">
        ...
        <Routes>
          ...
          <Route
            ...
            element={
              localStorage.getItem("email") ? (
                ...
                <h1 style={{ position: "relative", top: "10vh" }}>
                  Please log in
                </h1>
              )
            }
          ...
          <Route
            exact
            path="/transaction"
            element={buyDetails && <TransactionStatus data={buyDetails} />}
          ></Route>
          <Route
            exact
            path="/checkoutpage"
            element={<CheckoutPage onBuyCheckout={onBuyCheckoutHandler} />}
          ></Route>
          <Route
            exact
            path="/cropResults"
            element={<CropResults crop_data={crop_data} />}
          ></Route>
          <Route
            exact
            path="/CropSuggestionHistory"
            element={<CropSuggestionHistory history={history} />}
          ></Route>
          <Route
            exact
            path="/SearchByName/:query"
            element={<SearchResults />}
          ></Route>
          <Route
            exact
            path="/search/fertilizers/"
            element={
              prod_data && (
                <Market
                  data={prod_data.filter((x) => x.category === "fertilizers")}
                />
              )
            }
          ></Route>
          <Route
            ...
            element={
              prod_data && (
                <Market
                  data={prod_data.filter((x) => x.category === "seeds")}
                />
              )
            }
          ></Route>
          <Route
            ...
            element={
              prod_data && (
                <Market
                  data={prod_data.filter((x) => x.category === "pesticides")}
                />
              )
            }
          ></Route>
          <Route
            ...
            element={
              localStorage.getItem("email") ? (
                <Market
                  data={prod_data.sort(() => Math.random() - 0.5).slice(0, 11)}
                />
              ) : (
                <h1 style={{ position: "relative", top: "10vh" }}>
                  Please log in
          ...
          <Route
            exact
            path="/CropSuggestion"
            element={<CropSuggestion onSearch={CropSuggestionHistoryHandler} />}
          ></Route>
          <Route exact path="/discussions" element={<Discussions />}></Route>
          <Route
            exact
            path="/login"
            element={<Loginpage onUserLogin={onUserLogin} />}
          ></Route>
          <Route
            exact
            path="/signup"
            element={<Signuppage onUserLogin={onUserLogin} />}
          ></Route>
          <Route
            exact
            path="/adminportal"
            element={<AdminPortal data={prod_data} products={prod_data} />}
          ></Route>
          <Route
            exact
            path="/dashboard"
          ...
          <Route
            exact
            path="/croppage/:id"
            element={<CropPage data={crop_data} />}
          ></Route>
          <Route
            exact
            path="/productpage/:id"
            element={<ProductPage data={prod_data} />}
          ></Route>
        </Routes>
      </div>
    </Router>
